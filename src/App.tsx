...
import { AddRestriction } from "./pages/AddRestriction";
import { FocusRestriction } from "./pages/FocusRestriction";
...
const routes: RouteProps[] = [
    ...
    {
        path: "/restrictions/focus/:id",
        element: <FocusRestriction />,
    },
];
